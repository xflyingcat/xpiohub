...
int ports_detect__________________________________(void)
{
    ...
    if(p)
    {
        ...
        sprintf(cmdline,"md %s\\xpiohub",lister_path);
        system(cmdline);
        strcat(lister_path,"\\xpiohub");
                      ...
                      if(strstr(cmdline,"USB\\VID"))
                      {
                           ...
                           if(p && ((p - cmdline)<20))
                           {
                               *p = 0;
                               ...
                               {
                                  strcpy(ports_pull[i++].name,cmdline);
                               }
